...
class UiButton extends ButtonStyleButton {
  ...
  UiButton.filledSecondary({
    ...
    super.key,
        ...
        super(
          child: _ButtonIconAndLabel(
              icon: icon, label: label, iconAlignment: iconAlignment),
          onPressed: enabled ? onPressed : null,
          onLongPress: enabled ? onLongPress : null,
        );
  ...
  UiButton.filledDestructiveLoading({
    bool enabled = true,
    IconAlignment iconAlignment = IconAlignment.start,
    Widget? label,
    VoidCallback? onLongPress,
...
class _LoadingIcon extends StatelessWidget {
  const _LoadingIcon({
    super.key,
    this.variant = ButtonVariant.filledPrimary,
  });
  final ButtonVariant variant;
  ...
  Widget build(BuildContext context) {
    ...
    final color = switch (variant) {
      ButtonVariant.filledPrimary => palette.background,
      ButtonVariant.filledSecondary => palette.secondaryGradient2,
      ButtonVariant.filledDestructive => palette.destructive,
...
class _FilledButtonPrimaryStyle extends _UiBaseButtonStyle {
  ...
  WidgetStateProperty<Color?>? get backgroundColor =>
      WidgetStateProperty.resolveWith(
        (states) {
          if (states.contains(WidgetState.disabled)) {
            return colorPalette.grey7;
          }
          if (states.contains(WidgetState.pressed)) {
            return colorPalette.primary2.withOpacity(0.9);
          }
          return colorPalette.primary2;
        },
      );
  ...
  WidgetStateProperty<Color?>? get overlayColor =>
      WidgetStateProperty.resolveWith((Set<WidgetState> states) {
        final color = colorPalette.grey10;
  ...
  WidgetStateProperty<Color>? get shadowColor =>
      WidgetStatePropertyAll<Color>(colorPalette.border.withOpacity(.18));
}
...
class _FilledButtonSecondaryStyle extends _UiBaseButtonStyle {
  ...
  WidgetStateProperty<Color?>? get foregroundColor =>
      WidgetStateProperty.resolveWith(
        (Set<WidgetState> states) {
          ...
          return colorPalette.secondaryGradient2;
        },
      );
  ...
  WidgetStateProperty<Color?>? get overlayColor =>
      WidgetStateProperty.resolveWith((Set<WidgetState> states) {
        final color = colorPalette.secondaryGradient1;
...
class _FilledButtonDestructiveStyle extends _UiBaseButtonStyle {
  ...
  WidgetStateProperty<Color?>? get overlayColor =>
      WidgetStateProperty.resolveWith((Set<WidgetState> states) {
        final color = colorPalette.destructive;
...
class _UiBaseButtonStyle extends ButtonStyle {
  ...
  WidgetStateProperty<TextStyle?>? get textStyle =>
      WidgetStatePropertyAll(typography.regularLarge);
  ...
  Widget _backgroundBuilder(
    ...
    return OutlineFocusButtonBorder(
      ...
      border: RoundedRectangleBorder(
        side: BorderSide(color: colorPalette.border, width: 2),
        ...
        (Set<WidgetState> states) {
          if (states.contains(WidgetState.disabled)) {
            return RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(8),
              side: BorderSide(
                  color: colorPalette.border.withOpacity(0.12), width: 1),
            );
          }
...
class _IconButtonStandardStyle extends _IconButtonBaseStyle {
  ...
  WidgetStateProperty<Color?>? get overlayColor =>
      WidgetStateProperty.resolveWith(
        (Set<WidgetState> states) {
          if (states.contains(WidgetState.pressed)) {
            return colorPalette.border.withOpacity(0.1);
          }

          if (states.contains(WidgetState.hovered)) {
            return colorPalette.border.withOpacity(0.08);
          }
...
class _IconButtonBaseStyle extends _UiBaseButtonStyle {
  ...
  WidgetStateProperty<Color?>? get foregroundColor =>
      WidgetStateProperty.resolveWith((Set<WidgetState> states) {
        if (states.contains(WidgetState.disabled)) {
          return colorPalette.border.withOpacity(0.38);
        }
